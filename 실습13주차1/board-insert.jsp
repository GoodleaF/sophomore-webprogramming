...
<input type="submit" value="등록하기" onClick="location.href='board-insert-db.jsp'"/>
<input type="button" value="다시쓰기" onClick="location.href='board-insert.jsp'"/><br><br>

<img src="image\green_tree.gif"><a href="board-list.jsp">게시글 목록 보기</a><br>
<img src="image\island.gif">
</center>
</body>
</html>